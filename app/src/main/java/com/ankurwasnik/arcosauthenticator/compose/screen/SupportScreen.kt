...
import com.ankurwasnik.arcosauthenticator.viewmodels.support.SupportViewModel


@Composable
fun SupportScreen(
    title :String = "Arcos Support",
    modifier :Modifier = Modifier,
    theme : MaterialTheme = MaterialTheme,
    navController: NavController = rememberNavController()
) {

    val supportItemList = SupportViewModel().SupportItemList
